...
# Read in fonts
outfile.write('@font-face { font-family: OpenSans-Regular;src: url("../fonts/OpenSans/OpenSans-Regular.ttf");}\n')
...
outfile.write('table tbody tr td {\n    padding-left: 40% !important;\n    margin-bottom: 24px;\n  }\n')
outfile.write('table tbody tr td:last-child {\n    margin-bottom: 0;\n  }\n')
outfile.write('table tbody tr td:before {\n    font-family: OpenSans-Regular;\n    font-size: 14px;\n    color: #999999;\n    line-height: 1.2;\n    font-weight: unset;\n   position: absolute;\n    width: 40%;\n    left: 30px;\n    top: 0;\n }\n')
...
#End media
outfile.write('@media (max-width: 576px) { \n .container-table100 { \n padding-left: 15px; \n padding-right: 15px;}\n}')
